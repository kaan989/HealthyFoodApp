...
@Component({
  ...
  styleUrl: './dessert-recipes.component.css'
})
...
ngOnInit(): void {
  this.loadRecipesByCategory(4); // Belirli kategori ID'si
      ...
      if (result.isConfirmed) {
        this.recipeService.deleteRecipe(recipeId).subscribe(
          () => {
            ...
            this.loadRecipesByCategory(4);; // Silme işlemi başarılı olduktan sonra listeyi güncelleyin
          },
          error => {
            Swal.fire(
              'Error!',
